...
extension Backend {
    ...
    func createBusiness(image: Image?, name: String, description: String, token: String, callback: (Result<CreateBusinessResponse, BackendError<String>>) async -> Void) async {
