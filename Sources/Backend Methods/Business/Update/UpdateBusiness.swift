...
extension Backend {
    ...
    public func updateBusiness(name: String, description: String, image: Image?, userId: String, businessId: String, token: String, callback: (Result<ModifyBusinessResponse, BackendError<String>>) async -> Void) async {
